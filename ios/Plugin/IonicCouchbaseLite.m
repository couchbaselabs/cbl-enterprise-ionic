...
@implementation IonicCouchbaseLite {
    ...
    NSMutableDictionary<NSString*, id> *databaseChangeListeners;
    NSMutableDictionary<NSString*, id> *documentChangeListeners;
    NSMutableDictionary<NSString*, id> *queryChangeListeners;
...
-(void)load {
    ...
    databaseChangeListeners = [[NSMutableDictionary alloc] init];
    documentChangeListeners = [[NSMutableDictionary alloc] init];
    queryChangeListeners = [[NSMutableDictionary alloc] init];
